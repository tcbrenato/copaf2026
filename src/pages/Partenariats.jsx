...
const TR = {
  fr: {
    ...
    rgpdContent: [
      ...
      { title: '6. Vos droits', text: "Vous disposez des droits d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité. Contactez-nous à inscriptions@copaf-ports.com." },
    ],
  ...
  en: {
    ...
    rgpdContent: [
      ...
      { title: '6. Your rights', text: 'You have the right to access, rectify, erase, restrict, object to and port your data. Contact us at inscriptions@copaf-ports.com.' },
    ],
