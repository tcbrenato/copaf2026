  ...
  return (
    <div style={wrap}>
      <div style={card}>
        ...
        <div style={{ ...card, textAlign: 'center', marginTop: 20, marginLeft: 'auto', marginRight: 'auto' }}>
          <button onClick={telechargerPDF} disabled={pdfLoading} style={{
            padding: '11px 22px', background: '#fff', border: `1.5px solid #e2e8f0`,
            borderRadius: 12, color: NAVY, fontSize: 13, fontWeight: 700, cursor: pdfLoading ? 'default' : 'pointer',
