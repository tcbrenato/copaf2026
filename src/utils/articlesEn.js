...
export const ARTICLES_EN = {
  ...
  'copaf-2026-conference-ports-africains-ia-cybersecurite': {
    ...
    metaDescription: 'From 19 to 21 October 2026 in Casablanca, the African Ports Conference (COPAF 2026) brings together port leaders, experts and partners around the theme “African Smart Port: AI and cybersecurity serving performance”.',
    ...
    content: [
      { type: 'p', text: 'From 19 to 21 October 2026, Casablanca will host the African Ports Conference (COPAF 2026), an event dedicated to the digital transformation of the African port sector. Organised by CRF Perfection in partnership with AGPAOC (Association of Ports Management for West and Central Africa) and ANP/UAPNA, this edition has as its theme “African Smart Port: Artificial Intelligence and cybersecurity serving performance”.' },
      { type: 'h2', text: 'Three days, between strategic reflection and field immersion' },
      { type: 'p', text: 'The programme is built around three thematic days. The first sets the general framework of the “African Smart Port vision”, with plenaries and panels on the role of artificial intelligence in modernising port operations. The second day focuses on operational excellence, security and cybersecurity, with workshops dedicated to protecting connected port systems against cyber threats. The third day offers a field immersion, with a visit to the Port of Casablanca and its technological infrastructure, led by the teams of the National Ports Agency (ANP) and UAPNA.' },
  ...
  'visite-travail-casablanca-dg-crf-perfection-anp': {
    ...
    content: [
      ...
      { type: 'p', text: 'This meeting is part of the preparation for the next edition of the African Ports Conference, which will be held from 19 to 21 October 2026 in Casablanca, under the theme “African Smart Port: AI and Cybersecurity serving performance”.' },
