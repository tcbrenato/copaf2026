...
const TXT = {
  fr: {
    ...
    montantSuffix: (v) => `${v} (à régler par virement bancaire, impérativement avant le 09 octobre 2026)`,
    ...
    etapes: [
      ...
      "Exécutez le règlement par virement bancaire avant la date limite impérative du 09 octobre 2026.",
  ...
  en: {
    ...
    montantSuffix: (v) => `${v} (to be paid by bank transfer, no later than October 9, 2026)`,
    ...
    etapes: [
      ...
      'Complete payment by bank transfer no later than the strict deadline of October 9, 2026.',
