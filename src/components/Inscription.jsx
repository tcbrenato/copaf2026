...
const TR = {
  fr: {
    ...
    subtitleStep1: 'Sélectionnez la catégorie correspondant à votre profil.',
    subtitleStep2: 'Remplissez le formulaire. Paiement sécurisé par virement bancaire.',
    tutoBtn: "Voir le tutoriel vidéo : comment s'inscrire",
    backBtn: '\u2190 Changer de catégorie',
    types: {
      participant: { label:'Participant', sublabel:'Je participe à la conférence', desc:'Ports, autorités portuaires, logisticiens, shippers et tout professionnel du maritime.', tag:'par personne', cta:"S'inscrire maintenant" },
      sponsor:     { label:'Sponsor / Partenaire', sublabel:'Visibilité & partenariat', desc:'Sponsors Platine, Or, Argent, Bronze ou partenariat institutionnel, média, académique.', tag:'sponsors & partenaires', cta:'Voir les offres' },
    ...
    inclusList: [
      ...
      'Hébergement 4 nuitées en hôtel',
      'Petit-déjeuner & déjeuner pendant le séjour',
      'Accès aux conférences, ateliers & networking (Jours 1 et 2)',
      'Visite technique du port de Casablanca (Jour 3)',
    ...
    ph: { nom:'Votre nom', prenom:'Votre prénom', email:'votre@email.com', telephone:'+229 01 XX XX XX', organisation:'Port / Entreprise', poste:'Votre fonction' },
    paysPlaceholder: 'Sélectionnez votre pays',
    orgPlaceholder: 'Sélectionnez votre port / organisation',
    ...
    messageLabel: 'Message / Besoins spécifiques',
    messagePh: 'Questions, besoins alimentaires, accessibilité...',
    codePromoLabel: 'Code partenaire (facultatif)',
    codePromoPh: 'Code éventuel',
    paiementLabel: 'Mode de paiement *',
    paiementOpts: [
      { value:'maintenant', title:'Payer maintenant', desc:'Virement sous 7 jours ouvrables' },
      { value:'plus_tard',  title:'Reserver ma place', desc:'Paiement avant le 09 octobre 2026' },
    ],
    avantValiderTitle: 'À savoir avant de valider',
    avantValider1: 'Les inscriptions sont **définitives et non annulables** : aucun remboursement, quel que soit le motif (un collègue peut vous remplacer avec notification 72h avant).',
    avantValider2: 'Après votre email de confirmation, contactez-nous par WhatsApp ou email pour finaliser le paiement.',
    ...
    rgpdSuffix: '.',
    submitPay: 'Confirmer mon inscription', submitReserve: 'Réserver ma place', submitLoading: 'Envoi en cours...',
    secureNote: 'Paiement 100% sécurisé par virement bancaire. Aucune carte bancaire requise.',
    successTitlePay: 'Inscription enregistrée !', successTitleReserve: 'Place réservée !',
    successThanks: (p,n) => <>Merci <strong style={{ color:'#0f172a' }}>{p} {n}</strong>.<br/>Un email de confirmation a été envoyé à </>,
    downloadPdf: 'Télécharger mon récapitulatif (PDF)',
    dossierLabel: 'Numéro de dossier',
    actionTitle: 'Action obligatoire - Contactez-nous pour finaliser',
    actionText: 'Après réception de votre email de confirmation, vous devez obligatoirement nous contacter par WhatsApp ou email pour valider votre inscription et recevoir les instructions de virement.',
    prochainesTitle: 'Prochaines étapes',
    steps: [
      'Email de confirmation automatique envoyé',
      'Vous nous contactez par WhatsApp ou email',
      'Réception des instructions de virement',
      { pay:'Paiement sous 7 jours ouvrables', reserve:'Paiement avant le 09 octobre 2026' },
      'Badge et accès participant envoyés après paiement',
    ],
    verifRib: 'Vérifiez toujours le RIB avant de payer sur notre page dédiée.',
    verifNow: 'Vérifier maintenant \u2192',
    rappelTitle: 'Rappel :', rappelText: ' Les inscriptions sont définitives et non annulables. Aucun remboursement ne sera effectué. En cas d\'empêchement, vous pouvez vous faire remplacer par un collègue (notification 72h avant).',
    recapTitle: 'Récapitulatif', recapParticipants: 'Participants', recapTarif: 'Tarif unitaire', recapTotal: 'Total',
    virementTitle: 'Paiement par virement',
    verifAuth: "Vérifier l'authenticité de ce RIB",
    aideTitle: "Besoin d'aide ?", waContact: 'Contacter sur WhatsApp',
    nonRembTitle: 'Non remboursable',
    nonRembText: 'Les inscriptions sont définitives. Consultez nos ',
    nonRembCgv: 'CGV', nonRembSuffix: ' pour plus d\'informations.',
    cgvModalTitle: 'Conditions Générales de Vente',
    rgpdModalTitle: 'Politique de Confidentialité (RGPD)',
    modalClose: "J'ai lu et compris",
    cgvContent: [
      { title:'1. Objet', text:"Les présentes conditions générales de vente régissent les inscriptions à la Conférence des Ports Africains (COPAF 2026) organisée par CRF Perfection, prévue du 19 au 21 octobre 2026 à Casablanca, Maroc." },
      { title:'2. Inscription et confirmation', text:"Toute inscription n'est définitivement confirmée qu'après réception du paiement intégral. Après réception du mail de confirmation automatique, le participant doit contacter l'organisation par WhatsApp au +229 0169 30 30 19 ou par email à contact@copaf-ports.com pour valider son inscription et recevoir les instructions de paiement." },
      { title:'3. Tarifs et paiement', text:"Le tarif est fixé à 3 500 EUR par personne. Le paiement s'effectue exclusivement par virement bancaire. Le paiement doit être effectué dans les 7 jours ouvrables suivant la confirmation d'inscription. En cas de réservation (paiement différé), le règlement doit intervenir avant le 09 octobre 2026." },
      { title:'4. Politique de non-remboursement', text:"Les inscriptions sont définitives et non annulables. Aucun remboursement ne sera effectué, quelle que soit la raison de l'annulation (raison personnelle, professionnelle, médicale, force majeure, refus de visa, etc.). En cas d'empêchement, le participant peut se faire remplacer par une autre personne de son organisation sous réserve de notification écrite au moins 72h avant l'événement." },
      { title:"5. Annulation par l'organisateur", text:"En cas d'annulation de l'événement par l'organisateur pour des raisons de force majeure, un avoir sera proposé pour l'édition suivante. Aucun remboursement en numéraire ne sera effectué." },
      { title:'6. Droits et obligations', text:"Le participant s'engage à respecter le règlement intérieur de l'événement et à se comporter de manière professionnelle. L'organisateur se réserve le droit d'exclure tout participant ne respectant pas ces règles sans remboursement." },
      { title:'7. Responsabilité', text:"L'organisateur ne saurait être tenu responsable des frais de déplacement, d'hébergement ou de visa engagés par les participants. Il est recommandé de contracter une assurance annulation." },
      { title:'8. Litiges', text:"En cas de litige, les parties s'engagent à rechercher une solution amiable. À défaut, les tribunaux compétents de Cotonou, Bénin, seront saisis." },
    ],
    rgpdContent: [
      ...
      { title:'2. Données collectées', text:"Nous collectons : nom, prénom, email, téléphone, organisation, poste, pays. Ces données sont collectées lors de votre inscription." },
      { title:'3. Finalités', text:"Vos données servent à : la gestion de votre inscription, l'envoi des confirmations, la création de votre badge, la communication sur les éditions futures." },
      { title:'4. Base légale', text:"Le traitement est fondé sur l'exécution du contrat d'inscription (article 6.1.b du RGPD) et votre consentement explicite." },
      { title:'5. Conservation', text:"Vos données sont conservées pendant 3 ans à compter de la date de l'événement, sauf obligation légale contraire." },
      { title:'6. Destinataires', text:"Vos données peuvent être transmises aux partenaires organisant l'événement dans la stricte limite nécessaire. Elles ne sont jamais vendues." },
      { title:'7. Vos droits', text:"Vous disposez des droits d'accès, de rectification, d'effacement, de limitation, d'opposition et de portabilité. Contactez-nous à contact@copaf-ports.com." },
      { title:'8. Sécurité', text:"Nous mettons en œuvre toutes les mesures techniques et organisationnelles appropriées pour protéger vos données." },
    ],
    nonRembBanner: 'Politique de non-remboursement - Important',
    nonRembBannerText: "Les inscriptions sont **définitives et non annulables**. Aucun remboursement ne sera effectué quelle que soit la raison de l'annulation. En cas d'empêchement, le participant peut être remplacé par un collègue avec notification 72h avant l'événement.",
    docOfficiel: 'Page dédiée',
    waMsgFinaliser: dossier => `Bonjour, j'ai reçu la confirmation de mon inscription COPAF 2026. Dossier : ${dossier}. Je souhaite finaliser.`,
    waMsgQuestion: `Bonjour, j'ai une question concernant mon inscription à la COPAF 2026.`,
  ...
  en: {
    ...
    inclusList: [
      ...
      'Breakfast & lunch throughout the stay',
      'Access to conferences, workshops & networking (Days 1 and 2)',
      'Technical visit to the Port of Casablanca (Day 3)',
    ...
    paiementOpts: [
      ...
      { value:'plus_tard',  title:'Reserve my spot', desc:'Payment before October 9, 2026' },
    ],
    ...
    steps: [
      ...
      { pay:'Payment within 7 business days', reserve:'Payment before October 9, 2026' },
    ...
    cgvContent: [
      { title:'1. Purpose', text:'These terms and conditions of sale govern registrations for the Conference of African Ports (COPAF 2026), organised by CRF Perfection, to be held from 19 to 21 October 2026 in Casablanca, Morocco.' },
      ...
      { title:'3. Rates and payment', text:'The rate is set at EUR 3,500 per person. Payment is made exclusively by bank transfer. Payment must be made within 7 business days of registration confirmation. For deferred (reserved) payments, settlement must occur before 9 October 2026.' },
...
const TYPE_META = {
  ...
  sponsor:     { icon:'diamond', prix:'À partir de 8\u00A0000 EUR', redirect:true, redirectTo:'/partenariats', color:'#000E91', bg:'rgba(0,14,145,0.06)' },
  exposant:    { icon:'monitor', prix:'À partir de 500 EUR', redirect:true, redirectTo:'/exposition-digitale', color:'#0891b2', bg:'rgba(8,145,178,0.06)' },
}
