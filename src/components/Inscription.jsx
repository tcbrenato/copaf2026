...
const TR = {
  fr: {
    ...
    inclusList: [
      ...
      'Hebergement 4 nuitees en hotel',
      'Petit-dejeuner & dejeuner pendant le sejour',
      'Acces aux conferences, ateliers & networking (Jours 1 et 2)',
    ...
    cgvContent: [
      { title:'1. Objet', text:"Les presentes conditions generales de vente regissent les inscriptions a la Conference des Ports Africains (COPAF 2026) organisee par CRF Perfection, prevue du 19 au 21 octobre 2026 a Casablanca, Maroc." },
