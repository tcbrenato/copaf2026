...
const TR = {
  fr: {
    ...
    avantValider1: 'Les inscriptions sont **fermes et définitives** : aucun remboursement, quel que soit le motif (un collègue peut vous remplacer avec notification 72h avant).',
    ...
    rappelTitle: 'Rappel :', rappelText: ' Les inscriptions sont fermes et définitives. Aucun remboursement ne sera effectué. En cas d\'empêchement, vous pouvez vous faire remplacer par un collègue (notification 72h avant).',
    ...
    nonRembBannerText: "Les inscriptions sont **fermes et définitives**. Aucun remboursement ne sera effectué quelle que soit la raison de l'annulation. En cas d'empêchement, le participant peut être remplacé par un collègue avec notification 72h avant l'événement.",
