          ...
          {jour.sessions.map((s, k) => (
            ...
            >
              ...
              <div style={{
                ...
                fontWeight: 700, color: '#000e91', marginBottom: 8
              }}>
                {s.titre}
              </div>
              <div style={{
      ...
      <div style={{
        ...
        {[
          ...
          <div key={i} style={{
            ...
            <span style={{ fontSize: 'clamp(22px, 4vw, 28px)' }}>{info.icon}</span>
            <div>
              <div style={{
              ...
              <div style={{
                ...
                {[
                  ...
                  <div key={i} style={{
                    ...
                    <span style={{ fontSize: 14, color: '#555', textAlign: 'left' }}>{item}</span>
                  </div>
                ))}
              </div>
